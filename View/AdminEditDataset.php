            ...
            <div class="col-md-10">
                ...
                <form action="../Config/adminedit_ds.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="1o0" class="form-control" id="inputJudul" name="inpJudul" value="<?php echo $data->judul; ?>" placeholder="Masukkan judul" required>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn tombol" name="adminedit_ds" value="Save" style="margin-bottom:3rem; background-color: red; color:white;">Update</button><br>
                </form>
            </div>
        </div>
