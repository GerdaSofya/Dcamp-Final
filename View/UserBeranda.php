...
<body>
    ...
    <div class="topnav">
      <form class="example" method="POST" action="UserBeranda.php" style="margin:auto;max-width:300px">
  ...
  <div class="wrapper">
    ...
    if (isset($_POST['cari'])) {
      ...
      foreach ($row as $dataset1) {
        ...
        echo "      <p style='font-size: 18px;'><b><a href='UserPreviewDataset.php?judul=$dataset1->judul' class='text-dark text-decoration-none'>" . $dataset1->judul . "</a>&nbsp;&nbsp;</b><span
